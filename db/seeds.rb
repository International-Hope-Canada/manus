...
ItemSubcategory.reset_column_information
# require 'csv'
...
Setting.create!(setting_key: 'ihc_address', setting_value: "International HOPE Canada Inc.\nP.O. Box 23041\nRPO McGillivray\nWinnipeg, Manitoba, CANADA R3T 5S3\nEmail: info@internationalhope.ca\nwww.internationalhopecanada.ca")
Setting.create!(setting_key: 'ihc_charity_number', setting_value: '85942 7049 RR0001')
